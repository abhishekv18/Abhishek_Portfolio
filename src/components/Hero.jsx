...
//     <section
//       id="hero"
//       className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-gray-900 dark:via-gray-800 dark:to-black transition-all"
//     >
//       <div className="max-w-4xl mx-auto text-white">
//         <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight mt-10 lg:mt-0 tracking-wide  mt-15 lg:mt-0">
//           Hi, I'm <span className="text-yellow-400">Abhishek Agrawal</span>
//         </h1>

//         <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-200 dark:text-gray-400">
//           Full-Stack Developer & Creative Thinker
//         </h2>

//         <p className="text-lg md:text-xl mb-8 text-gray-300 dark:text-gray-200 max-w-3xl mx-auto">
//           I build modern, responsive web applications with beautiful UI/UX designs. Passionate about turning ideas into real-world products using React.js, Tailwind CSS, and the latest web technologies.
//         </p>

//         <div className="flex flex-col md:flex-row gap-6 justify-center">
//           <Link
//             to="/projects"
//             className="px-8 py-3 bg-yellow-400 text-gray-900 font-bold rounded-full hover:bg-yellow-500 hover:scale-105 transition-all transform duration-300"
//           >
//             View Projects
//           </Link>

//           <a
//             href="../assets/resume.pdf" // <-- Change to your resume link!
//             download
//             target="_blank"
//             rel="noopener noreferrer"
//             className="px-8 py-3 border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-indigo-600 transition-all transform hover:scale-105 duration-300"
//           >
//             Download Resume
//           </a>
//         </div>
